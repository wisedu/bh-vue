...
/***/ function(module, exports, __webpack_require__) {
	...
	var _datas = function _datas(data) {
	    data = _code(data);
	    if (data && data.datas) {
	        return data.datas;
	    } else {
	...
	var _firstRow = function _firstRow(data) {
	    data = _code(data);
	    if (data && data.datas && data.datas.rows) {
	...
	function postJson(url, params, processFunc) {
	    return http.post(url, params).then(function (response) {
	        return processFunc ? processFunc(response.data) : response.data;
	    });
	};

	function postForm(url, params, processFunc) {
	...
	function getJson(url, params, processFunc) {
	    return http.get(url, params).then(function (response) {
	        return processFunc ? processFunc(response.data) : response.data;
	    });
	};

	function promiseReq(url, params, processFunc) {
	    return new _promise2.default(function (resolve, reject) {
	        BH_UTILS.doAjax(url, params, 'POST').done(function (response) {
	            if (processFunc) {
	                try {
